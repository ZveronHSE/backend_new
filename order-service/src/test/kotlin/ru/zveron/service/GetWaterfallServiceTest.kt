...
import ru.zveron.test.util.testGetAnimalResponse
import ru.zveron.test.util.testGetSubwayResponse
import ru.zveron.test.util.testOrderWrapper
...
class GetWaterfallServiceTest {
    ...
    private val subwayClient = mockk<ru.zveron.client.address.SubwayGrpcClient>()
